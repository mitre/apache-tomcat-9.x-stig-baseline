...
passes them to hosted web applications via HTTP or AJP, and then sends the
results back to the requestor. Cryptographic ciphers are associated with the
...
included as part of the Java instance and the underlying Operating System. The
STIG checks to ensure the FIPSMode setting is enabled for the connector and
...
be configured to use the FIPS validated modules according to the chosen OS and
Java engine.
