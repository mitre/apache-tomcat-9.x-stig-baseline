control 'V-102579' do
  ...
  desc  "The $CATALINA_HOME/bin folder contains startup and control scripts for
the Tomcat Catalina server. To provide forensic evidence in the event of file
...
there are no results, this is a finding.
  ...
  tag gid: 'V-102579'
  tag rid: 'SV-111519r1_rule'
  tag stig_id: 'TCAT-AS-001590'
  tag fix_id: 'F-108111r1_fix'
  tag cci: ['CCI-000172']
  tag nist: ['AU-12 c']
