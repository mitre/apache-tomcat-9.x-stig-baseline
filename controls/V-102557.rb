...
operational/application needs, this is not a finding if the group permissions
are set in accordance with the risk acceptance. Ownership must not be changed.
...
xargs chgrp tomcat
  ...
  tag gid: 'V-102557'
  tag rid: 'SV-111497r1_rule'
  tag stig_id: 'TCAT-AS-001220'
  tag fix_id: 'F-108089r1_fix'
  tag cci: ['CCI-001813']
  tag nist: ['CM-5 (1)']
