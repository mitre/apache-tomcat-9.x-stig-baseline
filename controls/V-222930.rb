control 'V-222930' do
  ...
  desc '
  Tomcat has the ability to host multiple contexts (applications) on one
    physical server by using the <Host><Context> attribute. This allows the
    admin to specify audit log settings on a per application basis.

  Satisfies: SRG-APP-000016-AS-000013, SRG-APP-000080-AS-000045, SRG-
    APP-000089-AS-000050, SRG-APP-000091-AS-000052, SRG-APP-000095-AS-000056,
    SRG-APP-000098-AS-000061, SRG-APP-000099-AS-000062
  '
  desc 'rationale', ''
  ...
  impact 0.5
  tag severity: 'medium'
  tag gtitle: 'SRG-APP-000016-AS-0000131'
  tag gid: 'V-222930'
  tag rid: 'SV-222930r615938_rule'
  tag stig_id: 'TCAT-AS-000050'
  tag fix_id: 'F-24591r426235_fix'
  tag cci: %w(CCI-000067 CCI-000130 CCI-000133 CCI-000134 CCI-000166 CCI-000169 CCI-000172)
  tag nist: ['AC-17 (1)', 'AU-3', 'AU-10', 'AU-12 a', 'AU-12 c']
